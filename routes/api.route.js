...
router
  .route('/patient/saveDiagnosis/:patientId')
...
// appointment
router
  .route('/appointment/calendar/:doctorId/:patientId')
  .get(appointmentController.showCalendar);
router.route('/appointment/new').post(appointmentController.createAppointment);
router
...
router
  .route('/diagnosis/new')
  .post(upload.single('image'), diagnosisController.saveDiagnosis);
router
  .route('/diagnosis/edit/:diagnosisId')
  .put(diagnosisController.editDiagnosis);
router
  .route('/diagnosis/delete/:diagnosisId')
